'use strict';
/* build-hook-start *//*00001*/try { require('/Users/akashchand/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').default({tool: 'jest', checkSum: '2028f6b0fef6be15f8bb31AAFIAUwAXFUEBABRAQFQW1FRUQJQ', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/akashchand/.vscode/extensions/wallabyjs.console-ninja-1.0.406/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2028f6b0fef6be15f8bb31AAFIAUwAXFUEBABRAQFQW1FRUQJQ', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
